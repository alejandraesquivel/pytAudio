...
def abrir():
    ...
    '''
    ruta = filedialog.askopenfilename(title="Abrir", filetypes=(
    ("Fichero texto", "*.txt"), ("Fichero PDF", "*.pdf"), ("Todos los ficheros", "*.*")))
...
def guardar():
    ...
    '''
    fichero = filedialog.asksaveasfile(title="Guardar", mode="w+", defaultextension=".py", filetypes=(
    ("Fichero texto", "*.txt"), ("Fichero PDF", "*.pdf"), ("Todos los ficheros", "*.*")))
