...
class Window(Frame):
    ...
    def create_tabs(self):
       ...
       # self.create_canvas(page1)
        ...
        b11 = Button(page3, text="Low Pass FIR with Rec", bg="linen", fg="black")
        b11.place(x=115, y=750)
        b21 = Button(page3, text="High Pass FIR with Rec", bg="linen", fg="black")
        b21.place(x=285, y=750)
        b31 = Button(page3, text="Pass Band FIR with Rec", bg="linen", fg="black")
        b31.place(x=460, y=750)
        b41 = Button(page3, text="Split Band FIR with Rec", bg="linen", fg="black")
